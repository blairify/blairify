# Blairify
Blairify is a proprietary project. The source code in this repository is **not open-source**.
...
- Use it in commercial or non-commercial products
- Reverse engineer or decompile it

No rights are granted unless you have **written permission** or a **commercial license agreement** with the Blairify team.
