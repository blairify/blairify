        ...
        <main className="flex-1 overflow-auto">
          <div className="max-w-6xl mx-auto p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
            ...
            {results.whyDecision && (
              <Card
                className={
                  results.passed ? "border-blue-200" : "border-red-200"
                }
              >
                <CardHeader>
            ...
            {/* Next Steps */}
            {results.nextSteps &&
              results.nextSteps !== results.recommendations && (
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center text-base sm:text-lg">
                ...
                <Card className="bg-yellow-50 dark:bg-yellow-900/20 border-yellow-300 dark:border-yellow-700 border-2">
                  <CardContent className="py-4">
                    <p className="text-center text-sm sm:text-base text-yellow-800 dark:text-yellow-200 font-semibold">
                      ⚠️ We recommend waiting at least 3-6 months and completing
                      the suggested improvements before attempting another
                      interview at this level.
                    </p>
                  </CardContent>
                </Card>
