          ...
          {(question.languages ||
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                {question.frontendFrameworks &&
                  question.frontendFrameworks.length > 0 && (
                    <div>
                      <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">
                        Frontend
                      </p>
                      <div className="flex flex-wrap gap-1">
                        {question.frontendFrameworks.map((fw) => (
                          <span
                            key={fw}
                            className="px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs rounded"
                          >
                ...
                {question.backendFrameworks &&
                  question.backendFrameworks.length > 0 && (
                    <div>
                      <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">
                        Backend
                      </p>
                      <div className="flex flex-wrap gap-1">
                        {question.backendFrameworks.map((fw) => (
                          <span
                            key={fw}
                            className="px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs rounded"
                          >
                ...
                {question.databases && question.databases.length > 0 && (
                  <div>
                    <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">
                      Databases
                    </p>
                    <div className="flex flex-wrap gap-1">
                      {question.databases.map((db) => (
                        <span
                          key={db}
                          className="px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs rounded"
                        >
                ...
                {question.cloudProviders &&
                  question.cloudProviders.length > 0 && (
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {question.cloudProviders.map((cloud) => (
                          <span
                            key={cloud}
                            className="px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs rounded"
                          >
