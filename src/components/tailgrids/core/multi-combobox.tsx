...
export interface MultiComboboxProps<T extends object>
  extends Omit<ComboboxProps<T>, "value" | "defaultValue" | "onChange"> {
  value?: Key[];
  defaultValue?: Key[];
...
export interface MultiComboboxDisplayProps
