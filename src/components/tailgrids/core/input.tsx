...
const inputStyles = cva(
  "bg-input-background peer max-w-full h-10 rounded-lg border px-4 py-2.5 text-title-50 placeholder:text-input-placeholder-text focus:ring-3 disabled:border-base-100 disabled:text-input-disabled-text disabled:placeholder:text-input-disabled-text outline-none",
  {
    variants: {
      state: {
        default:
